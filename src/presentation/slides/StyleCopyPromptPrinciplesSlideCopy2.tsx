...
const IMAGES = {
  input: '/images/editing/wrong.png',
  output: '/images/editing/output.png',
} as const;

const PROMPT = 'Удали вторую лишнюю ракетку из указанной области';

export function StyleCopyPromptPrinciplesSlideCopy2({ index, totalSlides }: SlideRenderProps) {
  return (
