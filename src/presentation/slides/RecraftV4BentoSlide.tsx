...
const RIGHT_BOTTOM = [3, 4] as const;

export function RecraftV4BentoSlide({ index, totalSlides }: SlideRenderProps) {
  return (
    <SlideFrame padding="compact" className="relative isolate min-h-0">
      ...
      >
        <SlideHeader className="max-w-[1720px] shrink-0 gap-3">
          <Text variant="meta">{formatSlideMeta('Recraft V4', index, totalSlides)}</Text>
