...
const IMAGES = {
  input: '/images/editing/ref.jpg',
  output: '/images/editing/input.png',
} as const;

const PROMPT = 'Create a new brand character in this style: a tennis player on the court, wearing a different outfit color.';

export function StyleCopyPromptPrinciplesSlide({ index, totalSlides }: SlideRenderProps) {
  return (
